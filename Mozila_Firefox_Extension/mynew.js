...
//notify_bt.innerHTML="<img  src='"+browser.extension.getURL('icons/offline.png')+"' style='width:45px;height:45px'>"
var offline_icon=document.createElement("img")
offline_icon.src=browser.extension.getURL('icons/offline.png')
offline_icon.setAttribute("style","width:45px;height:45px")
notify_bt.appendChild(offline_icon)
...
//notify_bt1.innerHTML="<img src='"+browser.extension.getURL('icons/online.png')+"' style='width:45px;height:45px'>"
var online_icon=document.createElement("img")
online_icon.src=browser.extension.getURL('icons/online.png')
online_icon.setAttribute("style","width:45px;height:45px")
notify_bt1.appendChild(online_icon)
